...
const VerifyAccount = ({ navigation }) => {
  ...
  const fetchVerificationStatus = async () => {
    try {
      const response = await fetch(
        `http://192.168.0.123:5000/api/verify/status/${user._id}`,
      );
  ...
  const handleSendEmailOTP = async () => {
    ...
    try {
      const response = await fetch(
        "http://192.168.0.123:5000/api/verify/email-send-otp",
        {
          method: "POST",
  ...
  const handleVerifyEmailOTP = async () => {
    ...
    try {
      const response = await fetch(
        "http://192.168.0.123:5000/api/verify/email-verify-otp",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleSendPhoneOTP = async () => {
    ...
    try {
      const response = await fetch(
        "http://192.168.0.123:5000/api/verify/phone-send-otp",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  const handleVerifyPhoneOTP = async () => {
    ...
    try {
      const response = await fetch(
        "http://192.168.0.123:5000/api/verify/phone-verify-otp",
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
